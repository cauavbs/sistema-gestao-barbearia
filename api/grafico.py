"""
API do Gráfico Comparativo (grafico.html): agrega vários meses de uma
vez (cortes, freezer, entradas/saídas/lucro, desempenho por barbeiro e
formas de pagamento) para alimentar os gráficos Chart.js no front-end.
O Chart.js em si continua rodando no navegador (é só uma biblioteca de
desenho, não fala com o Firebase) — só os dados passaram a vir do
backend em vez de 4 listeners onValue soltos no JS.
"""
