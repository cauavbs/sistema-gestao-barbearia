...
Níveis de acesso confirmados nos arquivos HTML originais que você
enviou:
- Fichas e Faturamento (index.html): qualquer usuário logado (master
  ou barbeiro) — quem diferencia o que cada um vê é o perfil, não uma
  página separada.
- Todas as outras páginas administrativas (classificação, freezer,
  insumos, resultados, gráfico, relatório, lembrete, perfis): restritas
  a perfil 'master', confirmado pelo bloco onAuthStateChanged de cada
  arquivo original.
"""
