...
class Config:
    ...
    # Mesma "apiKey" que já existia no firebaseConfig do login.html antigo.
    # É usada para autenticar (e-mail/senha) contra o Firebase via REST API.
    FIREBASE_API_KEY = os.environ.get("FIREBASE_API_KEY", "")

    # URL do Realtime Database (mesma do firebaseConfig antigo: databaseURL)
